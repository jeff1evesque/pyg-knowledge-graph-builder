...
│   │   │                                   # the job manifest
│   │   ├── tables.py                       # The day-partitioned query tables a
│   │   │                                   # downstream service reads, over every
│   │   │                                   # source the run carried
...
│   │   ├── naming.py                       # One rule for node-type and relation
│   │   │                                   # names, and its inverse. No torch, so
│   │   │                                   # the enriching leg can use it
