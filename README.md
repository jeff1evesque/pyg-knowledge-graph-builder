...
| `--market_sector_definitions_key` | No | `""` | S3 key for the tickers CSV (e.g., `schwab/sp500/tickers/latest.csv`). Tickers are grouped by `GICS Sector` column to build sector patterns at runtime |
